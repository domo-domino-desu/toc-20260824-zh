...
in $x\mapsto y$). 
We say that~$x$ is an \definend{input}\index{input}\index{function!index} 
or \definend{argument}\index{argument}\index{function!argument} 
to the function,
and that~$y$ is an 
\definend{output}\index{output}\index{function!output} 
or \definend{value}.\index{value}\index{function!value}
...
\definend{image}\index{image}\index{function!image under} 
...
A function~$f$ is 
\definend{one-to-one},\index{one-to-one}\index{function!one0-to-one} 
or \definend{$1$-$1$} or
...
A function~$f$ is 
\definend{onto},\index{onto}\index{function!onto} 
or a 
...
$g$~is a \definend{left inverse}\index{left inverse}\index{function!left inverse}\index{inverse!left} 
function of~$f$, or what is the
same thing, $f$ is a 
\definend{right inverse}\index{right inverse}\index{function!right inverse}\index{inverse!right}  
of~$g$.
If $g$ is both a left and right inverse of~$f$ then
it is an 
\definend{inverse}\index{inverse}\index{inverse!two-sided}\index{function!inverse}\index{two-sided inverse} 
