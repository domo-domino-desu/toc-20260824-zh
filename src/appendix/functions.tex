...
\end{center}
The most common way to check that a function is one-to-one is to 
...
\end{center}
The most common way to check that a function is onto is to 
...
or \definend{bijection}, if it is both one-to-one and onto.
