...
$f(x)=\smash{\sqrt{2x^4+2x^2+15}}$, we are usually content to note 
...
In particular, in this subject we often have a function 
that is undefined on some elements of the domain; in this case, 
