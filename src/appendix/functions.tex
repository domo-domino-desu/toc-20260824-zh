...
\begin{exercise}   \label{CorrespondingSetsHaveSameNumberOfElements}
  Let $D$ and~$C$ be finite sets and consider $\map{f}{D}{C}$. 
  Prove these two, which together show
  that if~$f$ is a correspondence
  then the sets have the same number of elements.
