...
Following tradition, we denote an alphabet with
...
In place of $s_i$ we sometimes use square brackets, $\sigma[i]$.
This form allows us to use $\sigma[-1]$ for the final character, 
