...
may have \str{if} as a symbol that is indecomposable
...
to $\sequence{\str{a},\str{b},\str{c}}$.\footnote{%
  ...
  mean ~$\sequence{\str{a},\str{a}, \str{a}}$, $\sequence{\str{a},\str{aa}}$, 
...
Strings over $\B$ are  \definend{bitstrings},\index{bitstring}\index{bitstring!set of@set of, $\B$}
...
$\tau=\sequence{t_0,\ldots\, t_{m-1}}$ be strings over the same alphabet.
The 
