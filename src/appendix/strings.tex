...
or \definend{characters}.\index{character}
...
Tradition is to use the capital Greek letter~$\Sigma$ to denote alphabets.
We will name strings with lower case Greek letters 
(except that we reserve~$\TMfcn$ for something else)
and denote
items in a string with the associated lower case roman letter, as in
...
This allows us to use $\sigma[-1]$ for the final symbol, 
