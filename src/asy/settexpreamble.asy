...
string settexpreamble() {
  ...
  string usefiles = "\usepackage{"+path_prefix+"computingfonts}\usepackage{"+path_prefix+"contentmacros}\usepackage{"+path_prefix+"grammar}\usepackage{xcolor}\input{"+path_prefix+"colorscheme}";
