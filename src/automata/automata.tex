...
Our core object of study is the Turing machine.
To better understand a Turing machine we may isolate its components.
Turing machines have only two components, a CPU and a tape.
In this section we study the CPU alone, without a writeable tape.

Alternatively stated, 
Turing machines use an infinite tape. 
The devices that we use do not have unbounded memory.
...
Definition of FSA, motivated by CPU of a Turing machine.
...
Exercise: make a machine that plays tic-tac-toe.
