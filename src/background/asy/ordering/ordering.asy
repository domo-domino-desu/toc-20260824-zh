...
filldraw(pic, CE_bnd, fillpen=backgroundcolor, drawpen=black);

picture K_sets=new picture;
filldraw(K_sets, circle(K_loc, 0.15), fillpen=backgroundcolor, drawpen=black);
clip(K_sets, CE_bnd);
add(pic, K_sets);

picture comp_sets=new picture;
filldraw(comp_sets, circle(point(UNIVERSE, 0), 0.15), fillpen=backgroundcolor, drawpen=black);
