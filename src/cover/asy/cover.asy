...
int picnum = 0;
// size(pic,4cm);
path border = (0,0)--(8.5inch,0)--(8.5inch,11inch)--(0,11inch)--cycle;
fill(pic, border, pink_color);
// draw(pic, border, red);
// layer(pic);
label(pic,graphic("../computingdivision.jpg"),(4.35inch,5.5inch));
layer(pic);
...
real crop_top=8.1inch;
real crop_bottom=2.4inch;
real crop_left=0.35inch;
real crop_right=8.0inch;
...
label(pic, "\makebox[0in][c]{Theory of Computation}", (4.5inch,10inch), fontsize(40)+lightblack_color);
label(pic, "\makebox[0in][c]{\begin{tabular}{r}\Large Jim Hef{}feron \\[0.6ex] \texttt{http://joshua.smcvt.edu/computation}\end{tabular}}", (6inch,1inch), fontsize(14)+lightblack_color);
