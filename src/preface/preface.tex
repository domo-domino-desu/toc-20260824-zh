...
with a gap, such as graphs or big-$\bigOh$, there are optional review sections.
Programming experience, such as an introductory course,
would be a help.
...
A second example comes with the introduction of nondeterminism in the context
...
the work today,
and still another is the discussion of the current state of the question of
$\P$ versus $\NP$.
...
% ----------------------
\header{Schedule}
This is the semester's schedule that I follow.
...
\end{tabular}
\end{center}
An instructor could omit the readings but I give them as homework
and quiz on them.
...
\autocite{MeyerB}}.
But the main reason is that, as E~Dijkstra says, it is a delight.
...
inventory in a car dealership I can only say:~Thank you,
for believing in me.
