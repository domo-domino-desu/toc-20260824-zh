...
to Finite State machines, and is the dominant model in complexity.
The model's downside is that it is awkward for extensive computation.
However, here we don't do extensive computations.
We immediately go to a discussion of Church's Thesis, which,
besides giving some 
motivation and meaning to the formalities, allows us to
sketch algorithms,  
relying on the finely-tuned intuition that students have 
from their experience programming, and just using computers.
...
A third example comes with the inclusion in the
complexity material of a section of the kind of problems that drive
the work today,
and still another example
is the discussion of the current state of the question of
$\P$ versus~$\NP$.
All of these examples, and many more, are common in texts but taken together
they encourage students toward reflecting on the subject's larger ideas.
