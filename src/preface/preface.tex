...
as the first several quotes below express.
...
and also that there are Extra sections at the end of each chapter 
...
subject, starting by asking what
...
They should find that stuff makes sense.
...
Another example of enrichment in this text is a willingness to
the include informal discussion
(carefully differentiated from the formal text).
...
They cover a number of extra subjects related to the chapter.
These are suitable as one-day lectures, or for group work
or extra credit, or for a student just to read for pleasure.
...
\header{License}
This book is Free.
You can use it without cost, and you can redistribute it, for example
by posting it on a Learning Management System's directory for
your course.
You can also get the \LaTeX{} source from a repository
...
trail and it seems right to follow.
