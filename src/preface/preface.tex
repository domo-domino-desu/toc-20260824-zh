...
For graphs and Big-$\bigOh$ there are brief run-throughs, as 
...
The alternative of first covering Finite State machines
...
in outline rather than as programs for a computation model
