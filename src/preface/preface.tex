...
taken together
encourage students to connect with the underlying ideas.
...
The Theory of Computation is a fascinating subject.
This book aims to show that to readers, to draw them in, to be absorbing.
...
We want learners to build a mental scaffold for the material, and one
resource that is available, and good, is to ask them to
think through questions that other students have actually asked.
...
or extra credit, or just for reading for pleasure.
...
% ----------------------
\header{Schedule}
This is my most recent semester. 
