...
One way to stimulate readers to keep thinking is with links.
...
value\Dash I hope so, indeed\Dash but following the
masters seems only right.
...
I owe a debt to my wife, whose patience with this
...
Every time I pick up an introduction to programming
that uses as examples managing
