...
And clearly a theme in this century 
...
of different models leads to a deeper understanding of
...
introduces Turing machines, the second chapter covers unsolvability,
...
\end{tabular}
\end{center}
The semester ends with a discussion of the importance of
the $\P=\NP$ question.
...
First, the book is appealing.
It is written in lively language and
contains many illustrations (the electronic version
includes a number of animations),
from pictures of some of the people who have developed the topics students are
learning through to automata diagrams and graphs.
This is not 1960.
The Theory of Computation is a stimulating subject
and it deserves a presentation to match.

It also encourages active exploration through
the topic that end each chapter, which are both
fascinating and fun.
...
or as a file on their College's intranet.

This book is also Free in that you can get the \LaTeX{} source,
so you can modify it to suit your class.
See the home page \url{http://joshua.smcvt.edu/computation} for details. 

One reason that this book is Free is that it builds on things that are Free.
...
Besides, all of the research that this text
synthesizes is freely available.
I believe that the synthesis and the use of those tools adds
value\Dash I hope so, indeed\Dash but following this lead seems only right.
