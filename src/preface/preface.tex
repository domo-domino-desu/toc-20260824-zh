...
start, where we introduce 
our computing model, Turing machines.
In addition to being the traditional model, and to lead easily to Finite State
machine, they are the dominant model in complexity.
% Besides, as G\"{o}del and Church noted, they are clear. 
The usual downside of this model it that many authors have
extensive computations.
Here, we immediately go to a discussion of Church's Thesis.
Besides giving some feel for 
the motivation and meaning of the formalities, this allows us to
do very little programming with Turing machines, and instead
rely on the finely-tuned intuition that students have today 
from their extensive experience programming computers.
...
gives students a chance to reflect on the ideas.
...
% ----------------------
\header{Schedule}
I follow this is the semester's schedule 
(Chapter~I defines models of computation, Chapter~II covers unsolvability,
III does languages, IV does automata, and Chapter~V
