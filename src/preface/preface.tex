...
Starting the course with Finite State machines and Regular Languages is
...
(For this, we rely on the intuition that students have 
from their programming experience.
Besides motivating the formalities, this reliance allows us to
give algorithms in outline, rather than as programs for our computation model,
...
taken together,
encourage students to form the habit of making connections
...
For example, each person's picture is
...
The presentation also encourages engagement through 
the many notes in the back that fill out, and add a spark to, the 
core discussion.

We also make connections with other students of the subject, in that
many exercises were asked in online forums.
Learners need to build a mental scaffold for the material.
Patterns in forum questions 
suggest common snags in the process,
...
trail, and it seems only right to follow.
