...
Initiating the course by covering Finite State machines
may be mathematically slicker but to a fresh learner, instead
starting by asking what can be computed at all is more natural.
...
Besides providing the best start, this allows us to
