...
In addition to being the traditional model, and to lead naturally 
to Finite State machines, they are the dominant model in complexity.
% Besides, as G\"{o}del and Church noted, they are clear. 
The usual downside of this model is that it is awkward for
extensive computation.
But here we don't do extensive computations, instead 
we immediately go to a discussion of Church's Thesis.
Besides giving some feel for 
the motivation and meaning of the formalities, this allows us to
do a minimum of programming with Turing machines and instead
rely on the finely-tuned intuition that students have 
...
% ----------------------
\header{Schedule}
I follow this as the semester's schedule 
...
inventory in a car dealership I can only say to those three:~Thank you,
for believing in me.
