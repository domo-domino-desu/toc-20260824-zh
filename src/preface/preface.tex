...
proof methods including induction, quantifiers,
graphs,
basic number theory, 
...
a chanced to reflect on the underlying ideas.
...
Besides providing the best start, this discussion justifies
giving algorithms in outline rather than as programs for our computation model
...
Who among us has not had an Ah-ha!\@\ moment
in a hand-wavy hallway conversation? 

Finally, students can also explore
the end of chapter topics.
They cover a number of subjects related to the chapter and are
suitable as one-day lectures, or for group work
...
by posting it on a Learning Management System for
your course.
