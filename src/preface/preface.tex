...
The prerequisites are from a standard
Discrete Mathematics course:~propositional logic,
...
The presentation here aims for an understanding
...
start with our choice of computing model, the Turing machine.
...
historical images, and a few fun ones.
