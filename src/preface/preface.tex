...
Many of those ideas apply directly to a career in computing.
...
The big-$\bigOh$ section uses derivatives, so students need 
an introduction to Calculus.
They should also have some programming experience.
...
We introduce the model with careful motivation, and then
immediately discuss Church's Thesis, 
...
Another example is the inclusion in the
...
Chapter~III reviews languages, Chapter~IV does automata, and Chapter~V
...
an instructor can make copies and give it away or sell it
through their bookstore or their school's intranet.
...
as is our Scheme implementation,
