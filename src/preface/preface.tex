...
we will not see all of the details but we will see 
...
computation, and that seeing how those principles hold across the details
...
in particular, you can also redistribute it;  
...
See \url{http://joshua.smcvt.edu/computation} for details. 

One reason that this book is Free is that it is written in 
\LaTeX{}, which is Free, as is our Scheme implementation,
as is the Asymptote system used for the illustrations,
as is Emacs and the suite of GNU software,
and for that matter as is the entire Linux platform on which the work was done.
Besides, all of the research that this text
synthesizes is was made freely available by its authors.
I believe that the synthesis and the use of those tools adds
value\Dash I hope so, indeed\Dash but following the lead
of the masters seems only right.
...
\vspace{1ex plus .25ex minus .1ex}
\aphorism{[W]hile many distinguished scholars have embraced JASNA
...
\begin{flushright}
  \begin{tabular}{l@{}}
    ...
    Draft: version 0.70, \ymd{2018}{08}{22}.
  \end{tabular}
\end{flushright}
