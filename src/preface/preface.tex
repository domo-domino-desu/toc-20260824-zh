...
Oh, and there there is one more way in which the subject is awfully nice.
Isn't it clear to everyone that in the upcoming century one of the 
dominant forces will be the power of computation?
So it is timely, too. 

Besides these reasons, it also makes a delightful course.
Students learn both of the capabilities of comptuation, and
of the limits.
There are well-understood principles, and there are as-yet
undiscovered areas within easy reach.

This text aims to mirror all that: to be rigorous, topical,
and delightful.
...
you will hear the story told in a liberal way.
