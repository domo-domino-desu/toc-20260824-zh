...
gives students a chance to reflect for themselves on
...
This is not 1960\Dash photos and flowcharts were at one time 
...
One way to encourage readers to keep thinking is with links.
...
of the masters who came before seems only right.
...
I owe a debt to my wife, whose patience has gone beyond reasonable limits.
I also owe my students, who have also been patient.

And, I must acknowledge my teachers.
There are many but the first was M~Lerman, my mentor.
Thank you, Manny.
...
Every time I pick up a programming book that uses as examples managing
...
\begin{flushright}
  \begin{tabular}{l@{}}
    ...
    Draft: version 0.81, \ymd{2018}{12}{01}.
  \end{tabular}
\end{flushright}
