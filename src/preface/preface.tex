...
topical, insightful, stimulating, and perhaps sometimes a pleasure.



% ------------------------
\header{For students}
While you were learning to instruct 
computers to do your bidding, have you ever wondered
what cannot be done?
And what can be done in principle but not in practice?
In this course you will see signpost results in the study of these 
...
enough to end with
key insights and with a solid understanding of where the profession
...
We won't stint on precision\Dash why would we want to?\Dash 
but we will approach the ideas liberally, in a way that 
\citetext{attends to a breadth of knowledge}{%
...
in addition to technical detail.
We will be eager to
...
back of the book are many notes,
many of which contain links that will take you even deeper.
There are also Extra sections at the end of each chapter 
to explore further.
Whether or not your instructor covers them in class,
these can further your understanding of the material
and where it leads.

The subject is big and a challenge.
It will change the way that you see the world.
...
The prerequisite, besides an introduction to programming, is
Discrete Mathematics:~we rely on propositional logic,
...
giving algorithms
in outline or as working code in the Racket language,
which better communicates the ideas than code for a theoretical model
...
This text aims to showcase that,
to draw readers in, to be absorbing, including by
using lively language and many illustrations.

One way to encourage readers is to make the material explorable.
...
the many notes in the back that fill out the 
core presentation.
...
Finally, chapters end in a number of additional topic sections.
...
\end{tabular}
\end{center}
For those reading this text independently, I have marked a selection of exercises
...
your course.
Or, if you prefer, you can get bound book.
% You can also modify the \LaTeX{} source.
For the full details,
see the home page \url{https://hefferon.net/computation}. 

One reason for this license is the culture in which I have had the pleasure
to work.
The book is written using the 
\LaTeX{} tools, which are Free,
as is Asymptote that drew the illustrations,
along with Emacs and all of GNU software, as well as
the entire Linux platform on which this book was
developed.
And anyway, the research 
presented here was made freely available by scholars.

As well, there is a long tradition of making educational
work open.
I believe that the synthesis here adds
value\Dash I hope so, indeed\Dash but the masters have left a trail that is
well-marked and productive, and following it seems only right.


%---------------------------------------
\header{Acknowledgments}
I owe a great debt to my wife, whose patience with this
project has passed all reasonable bounds.
Thank you, Lynne.
...
Thank you, Manny.
They also include H~Abelson, GJ~Sussman, and J~Sussman, whose
\citetext{\textit{Structure  and Interpretation of Computer Programs}}{\autocite{Abelson}}
dared to show students how mind-blowing it all is.
When I see a computer text whose
examples are about managing inventory in
a used car dealership, I can only say:~Thank you,
for believing in me.
