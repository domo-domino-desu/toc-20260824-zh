...
The details matter.
But students can also fail to understand the subject because they had
a chance to reflect on the underlying ideas.
The presentation here stresses motivation and naturalness
and, where practical, sets the results in a network of contections.
...
and thereby rely on the intuition that students have 
...
than Turing machine code, or code written for any other 
...
giving students a chance to begin to think through this key idea.
...
contains many illustrations, including automata diagrams and graphs
but also including pictures of some of the people who have developed the topics,
historical images, and a few others just for fun.
...
In addition, 
there are many notes in the back that fill out, and add a spark to, the 
core presentation.

One way to stimulate readers to make it explorable.
