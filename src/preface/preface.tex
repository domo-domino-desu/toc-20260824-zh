...
not seen the ideas.
What sets the book apart is that the presentation aims
...
of finite state machines, where we again give a discussion that
it designed to give students a chance to feel that they understand
the ideas and have some sense of where they come from.
...
\begin{flushright}
  \begin{tabular}{l@{}}
    ...
    Draft: version 0.80, \ymd{2018}{11}{18}.
  \end{tabular}
\end{flushright}
