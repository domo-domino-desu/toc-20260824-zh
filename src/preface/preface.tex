...
\fbox{\parbox{0.9\textwidth}{\color{red}
  ...
  I apologize (I'd be glad for reports).
  It also means that the formatting has bugs.
  For instance, figures in the margins 
  may fall off the page.
  I apologize for this also; I 
  only get the chance to go through and 
  adjust those when I make a teaching version.}}
\end{center}
