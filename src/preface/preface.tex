...
It is full of ideas, wonderful and arresting ideas, that 
...
But our story is told in a liberal way, in a way that, 
...
We will be eager to
make connections with other fields, with things you have already
...
Discrete Mathematics course, covering propositional logic,
proof methods including induction,
graphs,
some number theory, 
sets, functions, and relations.
For the topics of graphs or big-$\bigOh$, 
there are optional review sections.
In the big-$\bigOh$ section we use derivatives.
I also expect programming experience.

A text does students a disservice if it is not precise.
The details matter.
...
start, with taking the Turing machine as our choice of computing model.
...
However, we don't do extensive computation.
...
than Turing machines or other code written for an abstract comuting model.
