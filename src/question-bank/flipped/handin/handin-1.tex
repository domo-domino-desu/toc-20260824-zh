...
\makebox[\textwidth]{\sc MA 208, Theory of Computation\hfill  Hand-in\hfill Due: 2021-Feb-01}
\vspace*{1ex}
\begin{center}
 \parbox{0.95\textwidth}{\textit{
  ...
  You are of course allowed to use any materials from the class, including
  the text, or the notes or discussions.
  }}
\end{center}
\vspace*{1ex}
\begin{questions}
