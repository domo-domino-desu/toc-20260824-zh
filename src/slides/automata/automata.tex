...
We can give a precise definition
...
$q$ is a state and $\tau\in\kleenestar{\Sigma}$.
The \definend{initial configuration}
is~$\mathcal{C}_0=\sequence{q_0,\tau_0}$,
where $\tau_0$ is the \definend{input}.
...
\begin{center}
  \includegraphics{asy/fsm09.pdf}
\end{center}
for all strings of length less than three.
\begin{center}
\begin{tabular}{r|*{7}{c}}
...
\end{center}
Give this machine the input \str{00001}.
\begin{center}\small
...
\begin{center}\small
  \vcenteredhbox{\includegraphics{\asydir nfsm/nfsm00.pdf}}
\end{center}
With input \str{00001}, the problem the machine faces is
...
\begin{center}
  \includegraphics[height=1.2in]{../../automata/pix/flauros.jpg}
\end{center}
\end{frame}
