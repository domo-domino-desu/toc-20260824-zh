...
\begin{example}
Give this machine an input of $\sigma=\str{abababb}$.
\begin{center}
  \includegraphics{asy/fsm09.pdf}
\end{center}
...
%     &$\mathcal{C}_4$ &$\mathcal{C}_5$ &$\mathcal{C}_6$ &$\mathcal{C}_7$ \\ 
%   \hline
%   $\sequence{q_0,\str{abababb}}$ &$\sequence{q_1,\str{bababb}}$ &$\sequence{q_1,\str{ababb}}$ &$\sequence{q_2,\str{babb}}$
%     &$\sequence{q_2,\str{abb}}$ &$\sequence{q_3,\str{bb}}$ &$\sequence{q_3,\str{b}}$ &$\sequence{q_3,\str{}}$ \\
% \end{tabular}
% \end{center}
\end{example}
