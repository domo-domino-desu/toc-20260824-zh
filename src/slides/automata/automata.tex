...
\end{center}
We will use the convention that the start state is $q_0$ 
...
whose effect is to govern the transitions that the machine makes
...
\end{center}
Give input \str{00001} to this machine.
\begin{center}\small
