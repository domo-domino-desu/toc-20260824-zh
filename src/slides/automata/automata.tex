...
whose effect is to move the machine from configuration to configuration.
That set is subject to the restriction that it must be
...
We will see examples, and its uses.
We will show that nondetermistic machines do the same jobs as deterministic
ones. 
\end{frame}


\begin{frame}{First mental model: lots of children}
