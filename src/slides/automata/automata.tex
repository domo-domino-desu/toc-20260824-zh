...
There is another way to proceed, the way that we actually do it.
...
How we handle this is to look forward, hoping to guess a 
finite sequence of legal steps that ends in the desired~$\sigma$.
\end{frame}



\begin{frame}{Example of a nondeterministic machine}
...
\pause
The Travelling Salesman problem illustrates.
