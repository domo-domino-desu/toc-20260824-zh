...
\pause
Inherient in the nature of mechanical computation, necessary to avoid
contradiction, is that sometimes a machine gets an input and fails to 
halt.
\end{frame}
...
$K=\set{e\suchthat \TM_e(e)\converges}$.
