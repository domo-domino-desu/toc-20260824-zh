...
\zexternaldocument{../../background/background}
...
editor the system derives its bitstring representation, and from the 
bitstring representation on the disc the system can recover the program's 
source.  
\begin{center}
...
% \end{center}
\ExecuteMetaData[\catchfilefn]{pf:smnii}
  
\ExecuteMetaData[\catchfilefn]{pf:smniii}\qedsymbol
\end{frame}
