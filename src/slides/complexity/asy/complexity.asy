...
yaxis(pic,"",ticks=LeftTicks(Label("$%.3g$"),
			     ...
			     Size=3, size=3),
      above=false);
draw(pic,graph(pic,g,0,5.25,operator ..),MAINPEN+linewidth(0.4pt)+highlight_fcn);
label(pic,"$g(x)=3x^2$",Scale(pic,(3.5,g(3.5))),E);
draw(pic,graph(pic,f,0,5.25,operator ..),MAINPEN+linewidth(0.4pt)+highlight_fcn);
...
draw(pic,graph(pic,h,0,5.25,operator ..),MAINPEN+linewidth(0.4pt)+highlight_fcn);
