...
We can mechanically recognize the language of the \HP,
\begin{equation*}
...
The definition allows a language to be
any subset of $\kleenestar{\Sigma}$, at all.
But in practice, usually there is a pattern.
Often the language follows rules.
...
The two example grammars above are recursive. 
...
For examples and exercises we may use capital letters as nonterminals
