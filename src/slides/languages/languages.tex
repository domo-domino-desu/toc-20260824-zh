...
A Turing machine can recognize the language of the set~$S$ of indices~$e$
such that $\TM_e$ halts on input~$3$,
but no Turing machine decides that set.
...
may fit the rules of wherever Yoda was raised but it does not fit the rules
for English.
