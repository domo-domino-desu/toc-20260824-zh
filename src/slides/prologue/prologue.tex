...
Usually these are questions in mathematics,
computer science, and the natural sciences.
(But we will extend to
the humanities, music, the visual arts, etc., if the work is 
ameniable.) 
Most importantly, we will ask what can be done 
systematically\Dash we shall not reach for a Ouija board.

That is, we shall take `systematically' to mean that the answer
can be given by a machine.
We will study what computers can and cannot do.
\end{frame}

\begin{frame}{Some history}
In 1928, one of the world's most famous mathematicians
D~Hibert and his student W~Ackermann proposed the
...
typographically, that is, 
by pushing symbols around without any intuition or unexplainable insights.
So verifying that a statement is true or false involves what we
today call an algorithm,
which you could cast into code and run on a computer.

But in 1928 there were no computers.
Thus, a question in the air at this time was to give a persuasive
...
He defined a mechanism which does the computing.
...
He took as a prototype a clerk doing by-hand multiplication
...
Imagine that we have a Turing machine that when given as input a string 
