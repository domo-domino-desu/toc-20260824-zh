...
that satisfies the system $(x,y,z)=(3/2,1/2,0)$  is fine
...
systematically, or uniformily\Dash Ouji boards don't count.
In short, 
...
define what can be mechanically computed, in a way that is 
...
The approach to to this definitino of mechanical computation 
...
numbers.
With that prototype he gave a number of principles that 
...
\begin{frame}{Second example coputation: addition of two numbers}
...
Church's Thesis to change it to \textit{No mechanism can \ldots{}}
...
often by giving some pseudo-code, and then invoke Church's Thesis.
